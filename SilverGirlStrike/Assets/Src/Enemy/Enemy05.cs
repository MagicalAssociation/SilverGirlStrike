...
namespace Enemy05
{
    ...
    {
        public NormalState(Enemy05 enemy)
            : base(enemy)
        {
        ...
        public override bool Transition(ref StateManager manager)
        {
            ...
            {
                manager.SetNextState((int)Enemy05.State.FALL);
                return true;
            }
    ...
    public class AttackState : BaseState
    {
        ...
        public override bool Transition(ref StateManager manager)
        {
            if (base.GetTime() > 60)
            {
                manager.SetNextState((int)Enemy05.State.NORMAL);
                return true;
            }
            return false;
        }
        ...
        private void CreateBullet()
        {
            ...
            {
                Bullet.MagicBullet.Create(this.enemy, this.enemy.bulletData[i]);
            }
        }
    }
    /**
    ...
    {
        public FallState(Enemy05 enemy)
            : base(enemy)
        {
        }
