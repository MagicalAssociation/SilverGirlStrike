...
public class ResultScreen : MonoBehaviour {
	...
	void Start () {
        ...
        CurrentData.GetDataInstance().GetData().stageClearFlag[number] = 1;
        CurrentData.GetDataInstance().GetData().stageClearTime[number] = (int)obj.GetComponent<GameResultData>().GetTime();
    }
